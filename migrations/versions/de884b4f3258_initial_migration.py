...
Revision ID: de884b4f3258
Revises: 
Create Date: 2025-09-10 18:43:07.827990
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('STUDENT', 'COUNSELOR', 'ADMIN', 'PEER_VOLUNTEER', name='userrole'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['counselor_id'], ['user.id'], ),
    ...
    op.create_table('counselor_profile',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('counselor_profile')
